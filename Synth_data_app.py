...
# Angenommen, die letzte Spalte ist die Zielvariable (y)
X_train = train_ds.iloc[:, :-1]  # Alle Spalten außer der letzten
y_train = train_ds.iloc[:, -1]   # Die letzte Spalte

X_test = test_ds.iloc[:, :-1]    # Alle Spalten außer der letzten
y_test = test_ds.iloc[:, -1]     # Die letzte Spalte
